...
// node_modules/kk-adapt-app/dist/es/FilePlayer-BNlLV0ZL.js
  ...
  constructor() {
    ...
    __publicField(this, "renderSourceElement", (source, index) => {
      if (typeof source === "string") {
        return import_react2.default.createElement("source", { key: index, src: source });
      }
      return import_react2.default.createElement("source", { key: index, ...source });
    });
    __publicField(this, "renderTrack", (track, index) => {
      return import_react2.default.createElement("track", { key: index, ...track });
    });
...
var FilePlayer$1 = getDefaultExportFromCjs(FilePlayer_1);
var FilePlayer$2 = _mergeNamespaces({
  __proto__: null,
...
//# sourceMappingURL=FilePlayer-BNlLV0ZL-V5DM4F64.js.map
