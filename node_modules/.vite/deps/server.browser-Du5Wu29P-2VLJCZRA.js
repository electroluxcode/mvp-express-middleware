...
// node_modules/kk-adapt-app/dist/es/server.browser-Du5Wu29P.js
  ...
  (function() {
          ...
          if (null != styleValue && "boolean" !== typeof styleValue && "" !== styleValue) {
            if (0 === styleName.indexOf("--")) {
              ...
              if (-1 < nameChunk.indexOf("-")) {
                var name = nameChunk;
                warnedStyleNames.hasOwnProperty(name) && warnedStyleNames[name] || (warnedStyleNames[name] = true, void 0);
              } else if (badVendoredStyleNamePattern.test(nameChunk))
                name = nameChunk, warnedStyleNames.hasOwnProperty(name) && warnedStyleNames[name] || (warnedStyleNames[name] = true, void 0);
              else if (badStyleValueWithSemicolonPattern.test(value)) {
                name = nameChunk;
                var value$jscomp$0 = value;
                warnedStyleValues.hasOwnProperty(value$jscomp$0) && warnedStyleValues[value$jscomp$0] || (warnedStyleValues[value$jscomp$0] = true, void 0);
              }
              "number" === typeof value && (isNaN(value) ? warnedForNaNValue || (warnedForNaNValue = true, void 0) : isFinite(value) || warnedForInfinityValue || (warnedForInfinityValue = true, void 0));
              nameChunk = styleName;
    ...
    function pushFormActionAttribute(target, resumableState, renderState, formAction, formEncType, formMethod, formTarget, name) {
      ...
      if ("function" === typeof formAction) {
        null === name || didWarnFormActionName || (didWarnFormActionName = true, void 0);
        null === formEncType && null === formMethod || didWarnFormActionMethod || (didWarnFormActionMethod = true, void 0);
        null === formTarget || didWarnFormActionTarget || (didWarnFormActionTarget = true, void 0);
    ...
    function pushAttribute(target, name, value) {
      switch (name) {
        ...
        case "preserveAlpha":
          ...
          break;
        case "inert":
          "" !== value || didWarnForNewBooleanPropsWithEmptyValue[name] || (didWarnForNewBooleanPropsWithEmptyValue[name] = true, void 0);
        case "allowFullScreen":
        case "async":
        case "autoPlay":
        case "controls":
    ...
    function checkSelectProp(props, propName) {
      ...
      null != value && (value = isArrayImpl(value), props.multiple && !value ? void 0 : !props.multiple && value && void 0);
    }
    function flattenOptionChildren(children) {
      var content = "";
      React.Children.forEach(children, function(child) {
        null != child && (content += child, didWarnInvalidOptionChildren || "string" === typeof child || "number" === typeof child || "bigint" === typeof child || (didWarnInvalidOptionChildren = true, void 0));
      });
      return content;
    }
    ...
    function pushScriptImpl(target, props) {
      ...
      target.push(endOfStartTag);
      null != children && "string" !== typeof children && (props = "number" === typeof children ? "a number for children" : Array.isArray(children) ? "an array for children" : "something unexpected for children", void 0);
      pushInnerHTML(target, innerHTML, children);
    ...
    function pushStartInstance(target$jscomp$0, type, props, resumableState, renderState, preambleState, hoistableState, formatContext, textEmbedded, isFallback) {
      ...
      !props.suppressContentEditableWarning && props.contentEditable && null != props.children && void 0;
      formatContext.insertionMode !== SVG_MODE && formatContext.insertionMode !== MATHML_MODE && -1 === type.indexOf("-") && type.toLowerCase() !== type && void 0;
      switch (type) {
        case "div":
        case "span":
        case "svg":
        ...
        case "select":
          ...
          void 0 === props.value || void 0 === props.defaultValue || didWarnDefaultSelectValue || (void 0, didWarnDefaultSelectValue = true);
        ...
        case "option":
              ...
              if (null != propValue$jscomp$1)
                switch (propKey$jscomp$1) {
                  ...
                  case "selected":
                    ...
                    didWarnSelectedSetOnOption || (void 0, didWarnSelectedSetOnOption = true);
                    break;
                  case "dangerouslySetInnerHTML":
          ...
          if (null != selectedValue) {
            if (null !== value) {
              ...
              null === innerHTML$jscomp$1 || didWarnInvalidOptionInnerHTML || (didWarnInvalidOptionInnerHTML = true, void 0), stringValue = flattenOptionChildren(children$jscomp$1);
        ...
        case "textarea":
          ...
          void 0 === props.value || void 0 === props.defaultValue || didWarnDefaultTextareaValue || (void 0, didWarnDefaultTextareaValue = true);
        ...
        case "input":
          ...
          null === formAction || "image" === props.type || "submit" === props.type || didWarnFormActionType || (didWarnFormActionType = true, void 0);
          ...
          null === checked || null === defaultChecked || didWarnDefaultChecked || (void 0, didWarnDefaultChecked = true);
          null === value$jscomp$1 || null === defaultValue$jscomp$0 || didWarnDefaultInputValue || (void 0, didWarnDefaultInputValue = true);
        ...
        case "button":
          ...
          null === formAction$jscomp$0 || null == props.type || "submit" === props.type || didWarnFormActionType || (didWarnFormActionType = true, void 0);
        ...
        case "form":
          ...
          if ("function" === typeof formAction$jscomp$1) {
            null === formEncType$jscomp$1 && null === formMethod$jscomp$1 || didWarnFormActionMethod || (didWarnFormActionMethod = true, void 0);
            null === formTarget$jscomp$1 || didWarnFormActionTarget || (didWarnFormActionTarget = true, void 0);
        ...
        case "title":
          ...
          if (hasOwnProperty.call(props, "children")) {
            ...
            Array.isArray(children$jscomp$6) && 1 < children$jscomp$6.length ? void 0 : "function" === typeof child || "symbol" === typeof child ? void 0 : child && child.toString === {}.toString && (null != child.$$typeof ? void 0 : void 0);
          }
        ...
        case "link":
          ...
          if (formatContext.insertionMode === SVG_MODE || formatContext.tagScope & 1 || null != props.itemProp || "string" !== typeof rel || "string" !== typeof href || "" === href) {
            "stylesheet" === rel && "string" === typeof props.precedence && ("string" === typeof href && href || void 0);
        ...
        case "style":
          ...
          if (hasOwnProperty.call(props, "children")) {
            ...
            ("function" === typeof child$jscomp$0 || "symbol" === typeof child$jscomp$0 || Array.isArray(child$jscomp$0)) && void 0;
          }
    ...
    function flushStyleTagsLateForBoundary(styleQueue) {
      ...
      0 < rules.length && 0 === hrefs.length && void 0;
      var i = 0;
      if (hrefs.length) {
    ...
    function preloadBootstrapScriptOrModule(resumableState, renderState, href, props) {
      (resumableState.scriptResources.hasOwnProperty(href) || resumableState.moduleScriptResources.hasOwnProperty(href)) && void 0;
    ...
    function escapeStringForLinkHeaderQuotedParamValueContext(value, name) {
      willCoercionThrow(value) && (void 0, testStringCoercion(value));
    ...
    function warnNoop(publicInstance, callerName) {
      ...
      didWarnAboutNoopUpdateForComponent[warningKey] || (void 0, didWarnAboutNoopUpdateForComponent[warningKey] = true);
    }
        ...
        if (null !== prevState && null !== deps) {
          a: {
            ...
            if (null === JSCompiler_inline_result)
              void 0, JSCompiler_inline_result = false;
            else {
              deps.length !== JSCompiler_inline_result.length && void 0;
      ...
      if ("function" === typeof type)
        if (type.prototype && type.prototype.isReactComponent) {
          ...
          if ("function" === typeof type.getDerivedStateFromProps && (null === instance.state || void 0 === instance.state)) {
            ...
            didWarnAboutUninitializedState.has(componentName) || (didWarnAboutUninitializedState.add(componentName), void 0);
          }
          ...
          instance.render || (type.prototype && "function" === typeof type.prototype.render ? void 0 : void 0);
          !instance.getInitialState || instance.getInitialState.isReactClassApproved || instance.state || void 0;
          instance.getDefaultProps && !instance.getDefaultProps.isReactClassApproved && void 0;
          instance.contextType && void 0;
          type.childContextTypes && !didWarnAboutChildContextTypes.has(type) && (didWarnAboutChildContextTypes.add(type), void 0);
          type.contextTypes && !didWarnAboutContextTypes$1.has(type) && (didWarnAboutContextTypes$1.add(type), void 0);
          "function" === typeof instance.componentShouldUpdate && void 0;
          type.prototype && type.prototype.isPureReactComponent && "undefined" !== typeof instance.shouldComponentUpdate && void 0;
          "function" === typeof instance.componentDidUnmount && void 0;
          "function" === typeof instance.componentDidReceiveProps && void 0;
          "function" === typeof instance.componentWillRecieveProps && void 0;
          "function" === typeof instance.UNSAFE_componentWillRecieveProps && void 0;
          var hasMutatedProps = instance.props !== resolvedProps;
          void 0 !== instance.props && hasMutatedProps && void 0;
          instance.defaultProps && void 0;
          "function" !== typeof instance.getSnapshotBeforeUpdate || "function" === typeof instance.componentDidUpdate || didWarnAboutGetSnapshotBeforeUpdateWithoutDidUpdate.has(type) || (didWarnAboutGetSnapshotBeforeUpdateWithoutDidUpdate.add(type), void 0);
          "function" === typeof instance.getDerivedStateFromProps && void 0;
          "function" === typeof instance.getDerivedStateFromError && void 0;
          "function" === typeof type.getSnapshotBeforeUpdate && void 0;
          var state = instance.state;
          state && ("object" !== typeof state || isArrayImpl(state)) && void 0;
          "function" === typeof instance.getChildContext && "object" !== typeof type.childContextTypes && void 0;
          ...
          if ("function" === typeof getDerivedStateFromProps) {
            ...
            if (void 0 === partialState) {
              ...
              didWarnAboutUndefinedDerivedState.has(componentName$jscomp$1) || (didWarnAboutUndefinedDerivedState.add(componentName$jscomp$1), void 0);
            }
          ...
          if ("function" !== typeof type.getDerivedStateFromProps && "function" !== typeof instance.getSnapshotBeforeUpdate && ("function" === typeof instance.UNSAFE_componentWillMount || "function" === typeof instance.componentWillMount)) {
            ...
            if ("function" === typeof instance.componentWillMount) {
              if (true !== instance.componentWillMount.__suppressDeprecationWarning) {
                ...
                didWarnAboutDeprecatedWillMount[componentName$jscomp$2] || (void 0, didWarnAboutDeprecatedWillMount[componentName$jscomp$2] = true);
              }
              instance.componentWillMount();
            }
            "function" === typeof instance.UNSAFE_componentWillMount && instance.UNSAFE_componentWillMount();
            oldState !== instance.state && (void 0, classComponentUpdater.enqueueReplaceState(
              instance,
              instance.state,
              null
            ));
          ...
          instance.props !== resolvedProps && (didWarnAboutReassigningProps || void 0, didWarnAboutReassigningProps = true);
          ...
          if (type.prototype && "function" === typeof type.prototype.render) {
            ...
            didWarnAboutBadClass[componentName$jscomp$3] || (void 0, didWarnAboutBadClass[componentName$jscomp$3] = true);
          }
          ...
          if (type.contextTypes) {
            ...
            didWarnAboutContextTypes[_componentName$jscomp$0] || (didWarnAboutContextTypes[_componentName$jscomp$0] = true, void 0);
          }
          type && type.childContextTypes && void 0;
          if ("function" === typeof type.getDerivedStateFromProps) {
            var _componentName2 = getComponentNameFromType(type) || "Unknown";
            didWarnAboutGetDerivedStateOnFunctionComponent[_componentName2] || (void 0, didWarnAboutGetDerivedStateOnFunctionComponent[_componentName2] = true);
          }
          if ("object" === typeof type.contextType && null !== type.contextType) {
            var _componentName3 = getComponentNameFromType(type) || "Unknown";
            didWarnAboutContextTypeOnFunctionComponent[_componentName3] || (void 0, didWarnAboutContextTypeOnFunctionComponent[_componentName3] = true);
          }
        ...
        if ("object" === typeof type && null !== type)
          switch (type.$$typeof) {
            ...
            case REACT_CONTEXT_TYPE:
              ...
              void 0 !== type._currentRenderer2 && null !== type._currentRenderer2 && type._currentRenderer2 !== rendererSigil && void 0;
              ...
              prevSnapshot$jscomp$0.context !== type && void 0;
              ...
              prevSnapshot !== task.context && void 0;
              return;
            case REACT_CONSUMER_TYPE:
              var context$jscomp$0 = type._context, render = props.children;
              "function" !== typeof render && void 0;
    ...
    function retryNode(request, task) {
      ...
      if (null !== node) {
        if ("object" === typeof node) {
          ...
          if (key && (type = key.call(node))) {
            if (type === node) {
              ...
              node.entries !== key || didWarnAboutMaps || (void 0, didWarnAboutMaps = true);
            node = type.next();
            if (!node.done) {
              key = [];
              do
        ...
        "string" === typeof node ? (task = task.blockedSegment, null !== task && (task.lastPushedText = pushTextInstance(
          ...
          request.renderState,
          task.lastPushedText
        ))) : ("function" === typeof node && (request = node.displayName || node.name || "Component", void 0), "symbol" === typeof node && void 0);
      }
    }
...
function requireReactDomServer_browser_development() {
  ...
  (function() {
    ...
    function stringToPrecomputedChunk(content) {
      ...
      2048 < content.byteLength && void 0;
      return content;
    }
    ...
    function createRenderState(resumableState, nonce, externalRuntimeConfig, importMap, onHeaders, maxHeadersLength) {
      ...
      onHeaders && "number" === typeof maxHeadersLength && 0 >= maxHeadersLength && void 0;
      importMap = onHeaders ? {
        preconnects: "",
        fontPreloads: "",
        highImagePreloads: "",
        ...
        if ("object" === typeof type && null !== type)
          switch (type.$$typeof) {
            ...
            case REACT_CONTEXT_TYPE:
              ...
              void 0 !== type._currentRenderer && null !== type._currentRenderer && type._currentRenderer !== rendererSigil && void 0;
    ...
    function flushCompletedQueues(request, destination) {
      ...
      try {
        ...
        0 === request.allPendingTasks && 0 === request.pingedTasks.length && 0 === request.clientRenderedBoundaries.length && 0 === request.completedBoundaries.length ? (request.flushScheduled = false, i = request.resumableState, i.hasBody && writeChunk(destination, endChunkForTag("body")), i.hasHtml && writeChunk(destination, endChunkForTag("html")), completeWriting(destination), 0 !== request.abortableTasks.size && void 0, request.status = CLOSED, destination.close(), request.destination = null) : completeWriting(destination);
      }
    }
    function startWork(request) {
      request.flushScheduled = null !== request.destination;
...
server_browser$1.version = l.version;
server_browser$1.renderToString = l.renderToString;
server_browser$1.renderToStaticMarkup = l.renderToStaticMarkup;
server_browser$1.renderToReadableStream = s.renderToReadableStream;
if (s.resume) {
  server_browser$1.resume = s.resume;
}
var server_browser = Object.freeze(Object.defineProperty({
  __proto__: null,
  default: server_browser$1
...
kk-adapt-app/dist/es/server.browser-Du5Wu29P.js:
  (**
   * @license React
...
kk-adapt-app/dist/es/server.browser-Du5Wu29P.js:
   ...
   *)
*/
//# sourceMappingURL=server.browser-Du5Wu29P-2VLJCZRA.js.map
